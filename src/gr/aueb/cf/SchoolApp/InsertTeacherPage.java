...
public class InsertTeacherPage extends JFrame {
	...
	public InsertTeacherPage() {									// με το που γίνεται activate η οθόνη, το comboBox cities
		addWindowListener(new WindowAdapter() {						// ανανεώνεται λαμβάνοντας περιεχόμενα από τη database
			@Override
			public void windowActivated(WindowEvent e) {
				cities = fetchCitiesFromDatabase();
				cities.forEach(city -> cityComboBox.addItem(city));	// populate το combo box
				...
				cityComboBox.setSelectedIndex(0);					// by default θ' αρχικοποιείται στην πόλη στο index 0 (Αθήνα)
				zipcodeText.setText("");
...
//				errorZipcode.setText("");
		...
		lastnameText.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(FocusEvent e) {
				errorLastname.setText(lastnameText.getText().trim().equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
			}
		});
		...
		vatText.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(FocusEvent e) {
				errorVat.setText(vatText.getText().trim().equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
			}
		});
		...
		fathernameText.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(FocusEvent e) {
				errorFathername.setText(fathernameText.getText().trim().equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
			}
		});
		...
		phoneNumberText.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(FocusEvent e) {
				errorPhoneNumber.setText(phoneNumberText.getText().trim().equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
			}
		});
		...
		emailText.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(FocusEvent e) {
				errorEmail.setText(emailText.getText().trim().equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
			}
		});
		...
		streetText.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(FocusEvent e) {
				errorStreet.setText(streetText.getText().trim().equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
			}
		});
		...
		streetNumberText.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(FocusEvent e) {
				errorStreetNumber.setText(streetNumberText.getText().trim().equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
			}
		});
		...
		zipcodeText.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(FocusEvent e) {
				errorZipcode.setText(zipcodeText.getText().trim().equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
			}
		});
		...
		insertBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				errorFirstname.setText(firstname.equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
				errorLastname.setText(lastname.equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
				errorVat.setText(vat.equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
				errorPhoneNumber.setText(phoneNumber.equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
				errorStreet.setText(street.equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
				errorFathername.setText(fathername.equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
				errorEmail.setText(email.equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
				errorStreetNumber.setText(streetNumber.equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
				errorZipcode.setText(zipcode.equals("") ? "Η συμπλήρωση του πεδίου είναι υποχρεωτική." : "");
				...
				String sql = "INSERT INTO teachers (firstname, lastname, vat, fathername, phonenum, "
				...
				try (PreparedStatement ps = conn.prepareStatement(sql)) {
					...
					int n = ps.executeUpdate();	// με .executeUpdate() κάνουμε Insert, Update και Delete
...
//					e1.printStackTrace();
	...
	private List<City> fetchCitiesFromDatabase() {
		...
		try (PreparedStatement ps = connection.prepareStatement(sql)) {		// υλοποιεί ένα δυναμικό statement - αποτελεί πόρο,
																			// γι' αυτό και μπαίνει σε try-with-resources
			
			ResultSet rs = ps.executeQuery();								// υλοποιεί τα αποτελέσματα που επιστρέφει το query
